...
def get_teams_colors(home_data,away_data) :
    ...
    home_team_c1 = colors[colors['team_id']==home_team_id]['color_1'].reset_index(drop=True)[0]
    home_team_c2 = colors[colors['team_id']==home_team_id]['color_2'].reset_index(drop=True)[0]
    away_team_c1 = colors[colors['team_id']==away_team_id]['color_1'].reset_index(drop=True)[0]
    away_team_c2 = colors[colors['team_id']==away_team_id]['color_2'].reset_index(drop=True)[0]   
